...
import type { SoxControl, ChangeRequest, VersionHistoryEntry } from '@/types';
...
export const mockChangeRequests: ChangeRequest[] = [
  ...
  },
  {
    ...
    changes: {
        ...
        // Campos que o Dono pode sugerir agora
        controlId: "OPS-010",
        ...
        n3Responsavel: "Gerência Comercial",
    },
    status: "Pendente",
  ...
  },
  {
  ...
  },
   {
    ...
    changes: {
        ...
        controlFrequency: "Diário",
        responsavel: "Carlos Pereira", // Mantendo o responsável
        n3Responsavel: "CFO", // Propondo novo N3
    },
    status: "Pendente",
...
export const mockVersionHistory: VersionHistoryEntry[] = [
  { id: "vh1", controlId: "1", changeDate: new Date(Date.now() - 86400000 * 30).toISOString(), changedBy: "Usuário Admin", summaryOfChanges: "Controle FIN-001 Criado.", newValues: { controlName: "Revisão de Conciliação Bancária", status: "Ativo", responsavel: "Carlos Pereira", n3Responsavel: "Gerência Financeira" } },
  ...
  { id: "vh3", controlId: "2", changeDate: new Date(Date.now() - 86400000 * 28).toISOString(), changedBy: "Usuário Admin", summaryOfChanges: "Controle ITG-005 Criado.", newValues: { controlName: "Aprovação de Acesso ao Sistema", status: "Ativo", responsavel: "Fernanda Lima", n3Responsavel: "Diretoria de TI" } },
  { id: "vh4", controlId: "3", changeDate: new Date(Date.now() - 86400000 * 26).toISOString(), changedBy: "Usuário Admin", summaryOfChanges: "Controle PRO-012 Criado.", newValues: { controlName: "Due Diligence de Integridade", status: "Ativo", responsavel: "Mariana Costa", n3Responsavel: "Gerência de Suprimentos" } },
  {
    id: "vh5",
    controlId: "3", // PRO-012
